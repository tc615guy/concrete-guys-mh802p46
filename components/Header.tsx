      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center space-x-6">
            ...
            <img
              src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/logo-1761495697758-qt8f3r.webp"
              alt="Concrete Guys"
            ...
            <div>
              <h1 className="text-3xl font-bold">Concrete Guys</h1>
              <p className="text-blue-200 text-base">Concrete Services</p>
            </div>
          </Link>
              ...
              <div>
                ...
                {servicesOpen && (
                  <div className="mt-2 ml-4 space-y-2">
                    ...
                    <Link
                      href="/services/sidewalk-installation"
                      className="block text-gray-600 hover:text-primary transition-colors"
                    >
                    ...
                    <Link
                      href="/services/concrete-sealing"
                      className="block text-gray-600 hover:text-primary transition-colors"
                    >
                      Concrete Sealing
                    </Link>
