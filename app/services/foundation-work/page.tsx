...
export const metadata: Metadata = {
  ...
  description: `Expert foundation work services in Nashville by Concrete Guys. Quality work, fair prices, and customer satisfaction guaranteed.`,
  openGraph: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Expert foundation work services in Nashville by Concrete Guys. Quality work, fair prices, and customer satisfaction guaranteed.
              </p>
