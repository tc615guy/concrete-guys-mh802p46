...
export const metadata: Metadata = {
  title: `Sidewalk Installation in Nashville, TN | Concrete Guys`,
  description: `Looking for sidewalk installation in Nashville? Concrete Guys provides reliable, professional service with attention to detail and competitive pricing.`,
  openGraph: {
    title: `Sidewalk Installation in Nashville, TN`,
    description: `Looking for sidewalk installation in Nashville? Concrete Guys provides reliable, professional service with attention to detail and competitive pricing.`,
    type: 'website',
  },
}
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-semibold">Sidewalk Installation</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Looking for sidewalk installation in Nashville? Concrete Guys provides reliable, professional service with attention to detail and competitive pricing.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Sidewalk Installation example 1"
                    fill
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Sidewalk Installation example 2"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Sidewalk Installation example 3"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Professional Sidewalk Installation in Nashville
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                <p>
                  At Concrete Guys, we specialize in providing top-quality sidewalk installation services 
                ...
                <p>
                  Whether you need sidewalk installation for your home or business, we have the expertise and 
                ...
                <div className="bg-blue-50 border-l-4 border-primary p-6 my-6">
                  ...
                  <p className="text-gray-700">Our comprehensive warranty program provides:
...
We guarantee resolution of any issues. This warranty represents our commitment to customer satisfaction.</p>
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us for Sidewalk Installation?</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">27+ Years of Experience</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">No-obligation quotes with transparent pricing</p>
                    </div>
                  </div>
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 sticky top-24">
                ...
                <ContactForm servicePreselect="Sidewalk Installation" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link href="/services/concrete-driveways" className="group bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary">
              <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">
                Concrete Driveways
              </h3>
              <p className="text-gray-600 text-sm mb-3">
                Professional concrete driveways services with quality workmanship.
              </p>
            ...
            <Link href="/services/concrete-patios" className="group bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary">
              <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">
                Concrete Patios
              </h3>
              <p className="text-gray-600 text-sm mb-3">
                Professional concrete patios services with quality workmanship.
              </p>
              <span className="text-primary font-semibold text-sm group-hover:underline">
                Learn More →
              </span>
            ...
            <Link href="/services/foundation-work" className="group bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary">
              <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">
                Foundation Work
              </h3>
              <p className="text-gray-600 text-sm mb-3">
                Professional foundation work services with quality workmanship.
              </p>
              <span className="text-primary font-semibold text-sm group-hover:underline">
                Learn More →
              </span>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact us today for a free estimate on your sidewalk installation project
          </p>
