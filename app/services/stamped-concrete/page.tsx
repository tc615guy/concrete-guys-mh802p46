...
export const metadata: Metadata = {
  title: `Stamped Concrete in Nashville, TN | Concrete Guys`,
  description: `Professional stamped concrete services in Nashville. Concrete Guys delivers expert results with quality workmanship and customer satisfaction guaranteed.`,
  openGraph: {
    title: `Stamped Concrete in Nashville, TN`,
    description: `Professional stamped concrete services in Nashville. Concrete Guys delivers expert results with quality workmanship and customer satisfaction guaranteed.`,
    type: 'website',
  },
}
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-semibold">Stamped Concrete</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Professional stamped concrete services in Nashville. Concrete Guys delivers expert results with quality workmanship and customer satisfaction guaranteed.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Stamped Concrete example 1"
                    fill
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Stamped Concrete example 2"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Stamped Concrete example 3"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Professional Stamped Concrete in Nashville
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                <p>
                  At Concrete Guys, we specialize in providing top-quality stamped concrete services 
                ...
                <p>
                  Whether you need stamped concrete for your home or business, we have the expertise and 
...
We guarantee resolution of any issues. This warranty represents our commitment to customer satisfaction.</p>
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us for Stamped Concrete?</h3>
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 sticky top-24">
                ...
                <ContactForm servicePreselect="Stamped Concrete" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link href="/services/sidewalk-installation" className="group bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary">
              <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors">
                Sidewalk Installation
              </h3>
              <p className="text-gray-600 text-sm mb-3">
                Professional sidewalk installation services with quality workmanship.
              </p>
              <span className="text-primary font-semibold text-sm group-hover:underline">
                Learn More →
              </span>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact us today for a free estimate on your stamped concrete project
          </p>
