        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden rounded-xl shadow-lg">
              <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495768274-9ap0eqi.webp" alt="Portfolio" className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110" loading="eager" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            
            <div className="relative group overflow-hidden rounded-xl shadow-lg">
              <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495769078-fivjj7.webp" alt="Portfolio" className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110" loading="eager" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            
            <div className="relative group overflow-hidden rounded-xl shadow-lg">
              <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495769435-s72wh6.webp" alt="Portfolio" className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110" loading="eager" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  <div className="bg-white p-3 rounded-lg shadow-md border border-gray-200">
                          <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495732720-r0fmya.webp" alt="Certification" className="h-12 w-auto object-contain" />
                        </div><div className="bg-white p-3 rounded-lg shadow-md border border-gray-200">
                          <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495732917-qzmc3.webp" alt="Certification" className="h-12 w-auto object-contain" />
                        </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-xl border-2 border-green-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow flex items-center justify-center">
                              <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/1761495787258-glrl7.webp" alt="Financing Partner" className="max-h-12 w-auto" />
                            </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl">
                ...
                <div className="flex flex-col items-center text-center">
                  <img src="https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/home-service-pro/logo-1761495723587-szvef.webp" alt="Joe Dyor" className="w-48 h-48 rounded-lg object-cover shadow-lg mb-4" loading="eager" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:email@concreteguys.com" className="text-blue-200 hover:text-white transition">
                        email@concreteguys.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
